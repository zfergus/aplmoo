...
/*  4 */ _CFFI_OP(_CFFI_OP_POINTER, 56), // cholmod_sparse *
/*  5 */ _CFFI_OP(_CFFI_OP_POINTER, 4), // cholmod_sparse * *
/*  6 */ _CFFI_OP(_CFFI_OP_NOOP, 5),
/*  7 */ _CFFI_OP(_CFFI_OP_POINTER, 53), // SuiteSparse_long * *
/*  8 */ _CFFI_OP(_CFFI_OP_POINTER, 55), // cholmod_common *
/*  9 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 10 */ _CFFI_OP(_CFFI_OP_FUNCTION, 4), // cholmod_sparse *()(cholmod_triplet *, size_t, cholmod_common *)
/* 11 */ _CFFI_OP(_CFFI_OP_POINTER, 57), // cholmod_triplet *
/* 12 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 28), // size_t
/* 13 */ _CFFI_OP(_CFFI_OP_NOOP, 8),
/* 14 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 15 */ _CFFI_OP(_CFFI_OP_FUNCTION, 11), // cholmod_triplet *()(cholmod_sparse *, cholmod_common *)
/* 16 */ _CFFI_OP(_CFFI_OP_NOOP, 4),
/* 17 */ _CFFI_OP(_CFFI_OP_NOOP, 8),
/* 18 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 19 */ _CFFI_OP(_CFFI_OP_FUNCTION, 11), // cholmod_triplet *()(size_t, size_t, size_t, int, int, cholmod_common *)
...
/* 27 */ _CFFI_OP(_CFFI_OP_FUNCTION, 1), // int()(cholmod_common *)
/* 28 */ _CFFI_OP(_CFFI_OP_NOOP, 8),
/* 29 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 30 */ _CFFI_OP(_CFFI_OP_FUNCTION, 1), // int()(cholmod_sparse * *, cholmod_common *)
/* 31 */ _CFFI_OP(_CFFI_OP_NOOP, 5),
/* 32 */ _CFFI_OP(_CFFI_OP_NOOP, 8),
/* 33 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 34 */ _CFFI_OP(_CFFI_OP_FUNCTION, 1), // int()(cholmod_triplet * *, cholmod_common *)
/* 35 */ _CFFI_OP(_CFFI_OP_POINTER, 11), // cholmod_triplet * *
/* 36 */ _CFFI_OP(_CFFI_OP_NOOP, 8),
/* 37 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 38 */ _CFFI_OP(_CFFI_OP_FUNCTION, 1), // int()(cholmod_triplet *, char const *, cholmod_common *)
/* 39 */ _CFFI_OP(_CFFI_OP_NOOP, 11),
/* 40 */ _CFFI_OP(_CFFI_OP_POINTER, 54), // char const *
/* 41 */ _CFFI_OP(_CFFI_OP_NOOP, 8),
/* 42 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 43 */ _CFFI_OP(_CFFI_OP_FUNCTION, 1), // int()(cholmod_triplet *, cholmod_common *)
/* 44 */ _CFFI_OP(_CFFI_OP_NOOP, 11),
/* 45 */ _CFFI_OP(_CFFI_OP_NOOP, 8),
/* 46 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 47 */ _CFFI_OP(_CFFI_OP_FUNCTION, 50), // void *()(size_t, size_t, void *, cholmod_common *)
/* 48 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 28),
/* 49 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 28),
/* 50 */ _CFFI_OP(_CFFI_OP_POINTER, 58), // void *
/* 51 */ _CFFI_OP(_CFFI_OP_NOOP, 8),
/* 52 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/* 53 */ _CFFI_OP(_CFFI_OP_POINTER, 3), // SuiteSparse_long *
/* 54 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 2), // char
/* 55 */ _CFFI_OP(_CFFI_OP_STRUCT_UNION, 1), // cholmod_common
/* 56 */ _CFFI_OP(_CFFI_OP_STRUCT_UNION, 0), // cholmod_sparse
/* 57 */ _CFFI_OP(_CFFI_OP_STRUCT_UNION, 2), // cholmod_triplet
...
_cffi_f_SuiteSparseQR_C_QR(PyObject *self, PyObject *args)
{
  ...
  if (datasize != 0) {
    if (datasize < 0)
      return NULL;
    x3 = (cholmod_sparse *)alloca((size_t)datasize);
  ...
  if (datasize != 0) {
    if (datasize < 0)
      return NULL;
    x4 = (cholmod_sparse * *)alloca((size_t)datasize);
  ...
  if (datasize != 0) {
    if (datasize < 0)
      return NULL;
    x5 = (cholmod_sparse * *)alloca((size_t)datasize);
  ...
  if (datasize != 0) {
    if (datasize < 0)
      return NULL;
    x6 = (SuiteSparse_long * *)alloca((size_t)datasize);
  ...
  if (datasize != 0) {
    if (datasize < 0)
      return NULL;
    x7 = (cholmod_common *)alloca((size_t)datasize);
  ...
  (void)self; /* unused */
  return _cffi_from_c_int(result, SuiteSparse_long);
}
#else
...
_cffi_f_cholmod_l_allocate_triplet(PyObject *self, PyObject *args)
{
  ...
  if (datasize != 0) {
    if (datasize < 0)
      return NULL;
    x5 = (cholmod_common *)alloca((size_t)datasize);
    memset((void *)x5, 0, (size_t)datasize);
...
_cffi_f_cholmod_l_check_triplet(PyObject *self, PyObject *args)
{
  ...
  if (datasize != 0) {
    if (datasize < 0)
      return NULL;
    x0 = (cholmod_triplet *)alloca((size_t)datasize);
  ...
  if (datasize != 0) {
    if (datasize < 0)
      return NULL;
    x1 = (cholmod_common *)alloca((size_t)datasize);
...
_cffi_f_cholmod_l_finish(PyObject *self, PyObject *arg0)
{
  ...
  if (datasize != 0) {
    if (datasize < 0)
      return NULL;
    x0 = (cholmod_common *)alloca((size_t)datasize);
    memset((void *)x0, 0, (size_t)datasize);
...
_cffi_f_cholmod_l_free(PyObject *self, PyObject *args)
{
  ...
  if (datasize != 0) {
    if (datasize < 0)
      return NULL;
    x3 = (cholmod_common *)alloca((size_t)datasize);
    memset((void *)x3, 0, (size_t)datasize);
...
_cffi_f_cholmod_l_free_sparse(PyObject *self, PyObject *args)
{
  ...
  if (datasize != 0) {
    if (datasize < 0)
      return NULL;
    x0 = (cholmod_sparse * *)alloca((size_t)datasize);
    memset((void *)x0, 0, (size_t)datasize);
...
_cffi_f_cholmod_l_print_triplet(PyObject *self, PyObject *args)
{
  ...
  if (datasize != 0) {
    if (datasize < 0)
      return NULL;
    x2 = (cholmod_common *)alloca((size_t)datasize);
    memset((void *)x2, 0, (size_t)datasize);
...
static const struct _cffi_global_s _cffi_globals[] = {
  ...
  { "cholmod_l_allocate_triplet", (void *)_cffi_f_cholmod_l_allocate_triplet, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 19), (void *)_cffi_d_cholmod_l_allocate_triplet },
  { "cholmod_l_check_triplet", (void *)_cffi_f_cholmod_l_check_triplet, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 43), (void *)_cffi_d_cholmod_l_check_triplet },
  { "cholmod_l_finish", (void *)_cffi_f_cholmod_l_finish, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_O, 27), (void *)_cffi_d_cholmod_l_finish },
  { "cholmod_l_free", (void *)_cffi_f_cholmod_l_free, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 47), (void *)_cffi_d_cholmod_l_free },
  { "cholmod_l_free_sparse", (void *)_cffi_f_cholmod_l_free_sparse, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 30), (void *)_cffi_d_cholmod_l_free_sparse },
  { "cholmod_l_free_triplet", (void *)_cffi_f_cholmod_l_free_triplet, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 34), (void *)_cffi_d_cholmod_l_free_triplet },
  { "cholmod_l_print_triplet", (void *)_cffi_f_cholmod_l_print_triplet, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 38), (void *)_cffi_d_cholmod_l_print_triplet },
  { "cholmod_l_sparse_to_triplet", (void *)_cffi_f_cholmod_l_sparse_to_triplet, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 15), (void *)_cffi_d_cholmod_l_sparse_to_triplet },
  { "cholmod_l_start", (void *)_cffi_f_cholmod_l_start, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_O, 27), (void *)_cffi_d_cholmod_l_start },
  { "cholmod_l_triplet_to_sparse", (void *)_cffi_f_cholmod_l_triplet_to_sparse, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 10), (void *)_cffi_d_cholmod_l_triplet_to_sparse },
};
...
static const struct _cffi_struct_union_s _cffi_struct_unions[] = {
  { "$cholmod_sparse", 56, _CFFI_F_OPAQUE,
    (size_t)-1, -1, -1, 0 /* opaque */ },
  { "cholmod_common", 55, 0,
    sizeof(cholmod_common), offsetof(struct _cffi_align__cholmod_common, y), 0, 0 },
  { "cholmod_triplet_struct", 57, _CFFI_F_CHECK_FIELDS,
    sizeof(cholmod_triplet), offsetof(struct _cffi_align__cholmod_triplet, y), 0, 12 },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__spqr(const void *p[])
{
...
PyInit__spqr(void)
{
  return _cffi_init("_spqr", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_spqr(void)
{
  _cffi_init("_spqr", 0x2601, &_cffi_type_context);
}
#endif
